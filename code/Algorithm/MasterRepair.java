...
public class MasterRepair {
    ...
    public MasterRepair(ArrayList<Long> td_time, ArrayList<ArrayList<Double>> td, ArrayList<ArrayList<Double>> md,
    ...
    public double master_repair(ArrayList<Long> td_time, ArrayList<ArrayList<Double>> td,
